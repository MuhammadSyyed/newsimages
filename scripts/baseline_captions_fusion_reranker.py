...
def baseline_captions_fusion_reranker(model_name, reranker_model_name, device, batch_size, k_reranking):
    ...
    logger.log_experiment(
        "../logs/logs.json",
        "Baseline with Captions Fusion and CLIP Reranking",
        model_name + " " + "Captions Fusion Reranking",
        "Evaluation",
        config={"fusion": True, "reranking": True},
        hyperparameters={"beta": 0.2,
                         "sim_threshold": 0.2, "top_k": k_reranking},
        metrics=metrics,
...
if __name__ == "__main__":
    ...
    baseline_captions_fusion_reranker(model_name, reranker_model_name, device, batch_size, k_reranking)